...
if __name__ == '__main__':
    food_data = pd.read_csv(os.path.join(script_dir, '..', 'data', 'food', 'food_dbpedia_raw.csv'), sep="\t")
    ...
    food_data_words.to_csv(os.path.join(script_dir, '..', 'data', 'food', 'food_dbpedia_tidy.csv'),
