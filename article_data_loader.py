...
def get_articles_nxmls(articles_directory):
    articles_folderpathes = (os.path.join(articles_directory, foldername) for foldername in os.listdir(articles_directory))
    articles_filepathes = (os.path.join(folderpath, file) for folderpath in articles_folderpathes for file in os.listdir(folderpath))
