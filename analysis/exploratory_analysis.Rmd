...
data.food <- data[,.(unlist(llply(str_match_all(food, 
                      ...
                      unlist(llply(str_match_all(food, 
                                   ...
                                   .fun=function(x) x[,2]))),
         by=.(text, article_title)]
setnames(data.food, c("text","article_title","food","foodgroup"))
...
ggplot(data, aes(x=length)) + geom_histogram(binwidth=400) +
...
plots <- PlotHist(data.nutrient.count, "nutrient")
plots[[1]]
plots[[2]]
```
...
plots <- PlotHist(data.disease.count, "disease")
plots[[1]]
plots[[2]]
```
...
plots <- PlotHist(data.food.count, "food")
plots[[1]]
plots[[2]]
```
Группы:
...
plots <- PlotHist(data.food.group.count, "foodgroup")
plots[[1]]
plots[[2]]
```
